...
#SBATCH --job-name="bDGlc13bDGal_PMF"
#SBATCH --mail-user= CLSTAY002@myuct.ac.za
#SBATCH --mail-type=ALL


#cd output/bDGlc13bDGal/bDGlc13bDGal
...
/opt/exp_soft/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 run.conf > runbDGlc13bDGal.log
