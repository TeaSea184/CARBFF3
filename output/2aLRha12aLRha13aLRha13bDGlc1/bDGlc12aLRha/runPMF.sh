...
#SBATCH --job-name= "bDGlc12aLRha_PMF"
#SBATCH --mail-user= CLSTAY002@myuct.ac.za
#SBATCH --mail-type=ALL


#cd output/2aLRha12aLRha13aLRha13bDGlc1/bDGlc12aLRha
...
/opt/exp_soft/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 run.conf > runbDGlc12aLRha.log
