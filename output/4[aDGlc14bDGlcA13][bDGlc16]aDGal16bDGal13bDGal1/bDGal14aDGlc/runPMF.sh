...
#SBATCH --job-name="bDGal14aDGlc_PMF"
#SBATCH --mail-user= CLSTAY002@myuct.ac.za
#SBATCH --mail-type=ALL


#cd output/4[aDGlc14bDGlcA13][bDGlc16]aDGal16bDGal13bDGal1/bDGal14aDGlc
...
/opt/exp_soft/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 run.conf > runbDGal14aDGlc.log
