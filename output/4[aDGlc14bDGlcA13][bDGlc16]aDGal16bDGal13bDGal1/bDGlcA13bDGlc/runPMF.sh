...
#SBATCH --nodes=1 --ntasks=10 --gres=gpu:2 
#SBATCH --time=24:00:00
#SBATCH --mem-per-cpu=2000
#SBATCH --job-name="bDGlcA13bDGlc_PMF"
#SBATCH --mail-user= CLSTAY002@myuct.ac.za
#SBATCH --mail-type=ALL


#cd output/4[aDGlc14bDGlcA13][bDGlc16]aDGal16bDGal13bDGal1/bDGlcA13bDGlc
...
/opt/exp_soft/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 run.conf > runbDGlcA13bDGlc.log
