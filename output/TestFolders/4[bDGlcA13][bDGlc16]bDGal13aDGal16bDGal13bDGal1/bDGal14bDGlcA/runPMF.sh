...
#SBATCH --job-name="bDGal14bDGlcA_PMF"
#SBATCH --mail-user= CLSTAY002@myuct.ac.za
#SBATCH --mail-type=ALL


#cd output/4[bDGlcA13][bDGlc16]bDGal13aDGal16bDGal13bDGal1/bDGal14bDGlcA
...
/opt/exp_soft/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 run.conf > runbDGal14bDGlcA.log
