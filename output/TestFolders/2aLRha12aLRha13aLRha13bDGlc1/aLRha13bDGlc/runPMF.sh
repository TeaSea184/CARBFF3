...
#SBATCH --job-name= "aLRha13bDGlc_PMF"
#SBATCH --mail-user= CLSTAY002@myuct.ac.za
#SBATCH --mail-type=ALL


#cd output/2aLRha12aLRha13aLRha13bDGlc1/aLRha13bDGlc
...
/opt/exp_soft/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 run.conf > runaLRha13bDGlc.log
