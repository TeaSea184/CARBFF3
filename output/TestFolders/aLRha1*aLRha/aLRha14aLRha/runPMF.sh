...
#SBATCH --job-name="aLRha14aLRha_PMF"
#SBATCH --mail-user= CLSTAY002@myuct.ac.za
#SBATCH --mail-type=ALL


#cd output/aLRha1*aLRha/aLRha14aLRha
...
/opt/exp_soft/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 run.conf > runaLRha14aLRha.log
