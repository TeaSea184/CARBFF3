...
#SBATCH --job-name="bDGlc12bDGal_PMF"
#SBATCH --mail-user= CLSTAY002@myuct.ac.za
#SBATCH --mail-type=ALL


#cd output/bDGlc1*bDGal/bDGlc12bDGal
...
/opt/exp_soft/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 run.conf > runbDGlc12bDGal.log
