...
#SBATCH --job-name="bDGal12bDGal_PMF"
#SBATCH --mail-user= CLSTAY002@myuct.ac.za
#SBATCH --mail-type=ALL


#cd output/bDGal1*bDGal/bDGal12bDGal
...
/opt/exp_soft/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 run.conf > runbDGal12bDGal.log
