...
#SBATCH --job-name="bDGlc14bDGlc_PMF"
#SBATCH --mail-user= CLSTAY002@myuct.ac.za
#SBATCH --mail-type=ALL


#cd output/bDGlc14bDGlc/bDGlc14bDGlc
...
/opt/exp_soft/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 run.conf > runbDGlc14bDGlc.log
